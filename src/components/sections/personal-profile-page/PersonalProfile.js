    ...
    <React.Fragment>
      ...
      <Container sx={{ padding: '5vmin', minHeight: '100vh', border: border }}>
        <Box sx={{ border: border }} >
          <Grid container>
            <Grid item={true} md={12} sm={12} xs={12} sx={{ display: { sm: 'block', md: 'none' }, border: border }}>
              <Box style={{ display: 'grid', placeItems: 'center center', width: '100%' }}>
                <AnimatedPic width='50%' />
              </Box>
            </Grid>
            <Grid item={true} md={12} sm={12} xs={12} sx={{ display: { xs: 'block', sm: 'block', md: 'block' }, border: border }}>
            ...
            <Grid item={true} md={12} sm={12} xs={12}>
              <Grid container sx={{ border: border, height: '100%' }}>
                <Grid item={true} md={7} sm={12} xs={12} sx={{ border: border, height: '100%' }}>
                  <Box style={{ display: 'grid', placeItems: 'center center', height: '100%', border: border }}>
                    <PersonalInfo />
                  </Box>
                </Grid>
                <Grid item={true} md={4} sm={12} xs={12} sx={{ display: { xs: 'none', sm: 'none', md: 'block' }, border: border, placeItems: 'center center', height: '100%' }}>
            ...
            <Grid item={true} md={12} sm={12} xs={12} sx={{ border: border, placeItems: 'center center', width: '100%' }}>
