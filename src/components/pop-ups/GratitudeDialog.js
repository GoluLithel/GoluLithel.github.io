...
export default function GratitudeDialog({open, handleGratitudeClose, handleChangePanel}) {

  const changeToContacts = () => {
    handleGratitudeClose();
    handleChangePanel('Contacts');
  }
  return (<Dialog
    open={open}
    onClose={handleGratitudeClose}
